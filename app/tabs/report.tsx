...
export default function ReportScreen() {
  ...
  const groupTransactions = () => {
    if (!transactions.length) return { labels: [], data: [], hasData: false };
  ...
  const { labels, data, hasData } = groupTransactions();
  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <View style={[styles.subContainer, { alignItems: "center" }]}>
        ...
        <Text style={[styles.text, { fontSize: 30, color: "#D2996C" }]}>
      ...
      <View style={styles.subContainer}>
        <Text
          style={[
            styles.text,
            { color: "#3A2A21", fontSize: 16, marginBottom: 10 },
          ]}
        >
          Recent Transactions:
        </Text>
