...
export default function Dashboard() {
  ...
  const { totalBudget, totalSpent, percentageUsed, refresh } =
    useUserFinanceData();

  let hasLoggedUserExists = false;
  ...
  const ensureUserRowExists = async (user: any) => {
    ...
    } else if (!hasLoggedUserExists) {
      console.log("User row already exists");
      hasLoggedUserExists = true; // to not spam with the message that the user already exists.
    }
  };
  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <View style={[styles.subContainer, { paddingTop: 30 }]}>
        <View style={{ flexDirection: "column", gap: 20 }}>
          ...
          <View style={{ flexDirection: "column", gap: 20 }}>
            <View>
              <View style={styles.rowBetween}>
                <View style={styles.row}>
                  <View
                    style={[styles.legend, { backgroundColor: "#B6A089" }]}
                  />
              ...
              <View style={styles.rowBetween}>
                <View style={styles.row}>
                  <View
                    style={[styles.legend, { backgroundColor: "#5C4630" }]}
                  />
            ...
            <Link
              style={[styles.linkStyle, { alignSelf: "flex-end" }]}
              href="/tabs/report"
            >
              View Breakdown
            </Link>
      ...
      <View style={styles.subContainer}>
        <Text style={[styles.containerTitle, { marginBottom: 10,}]}>Reminders</Text>
        <ReminderCard />
      </View>
