    ...
    return(
        <View style={styles.container}>
            ...
            <View style={{width:310, marginBottom:30}}>
                ...
                {emailSent && (
                    <Text style={styles.resetMessageText}>Reset password link has been sent to your email.</Text>)
                }
            </View>
            <LoginButton buttonLabel="Reset Password" style={{backgroundColor: '#C6844F'}} 
