...
export default function AddSavingsModal({ visible, onClose, goalId, onSaveComplete }: AddSavingsModalProps) {
        ...
        <View style={styles.modalContainer}>
          <View style={{ flexDirection: 'row', justifyContent: 'space-between', width: '100%' }}>
            {presetValues.map(value => (
              <Pressable key={value} style={styles.amountButton} onPress={() => handlePreset(value)}>
          ...
          <View style={{ flexDirection: 'row', justifyContent: 'space-between', marginTop: 10, width: '100%' }}>
            <Text style={{ color: '#A3C9A8', fontWeight: 'bold', fontSize: 18 }}>Custom Amount:</Text>
          ...
          <View style={{ flexDirection: 'row', gap: 10 }}>
            <Pressable style={[styles.button, { backgroundColor: '#A3C9A8', borderColor: '#A3C9A8' }]} onPress={handleSave}>
              <Text style={[styles.buttonText, { color: '#FFFFFF' }]}>Enter</Text>
            </Pressable>
            <Pressable style={[styles.button, { borderColor: '#A3C9A8' }]} onPress={onClose}>
