    ...
    >
      <View style={styles.overlay}>
        <View style={styles.modalContainer}>
          ...
          >
            Help yourself stay on track and reach your goals by setting a limit
            for this category.
          </Text>
          ...
          >
            ...
            <View style={{ flex: 1, marginLeft: 10 }}>
              <DropDownPicker
                ...
                textStyle={[
                  styles.text,
                  { fontSize: 12, fontFamily: "Montserrat_500Medium" },
                ]}
          ...
          {/* Cancel Button */}
          <Pressable
            style={[styles.button, { borderWidth: 2, borderColor: "#C3905E" }]}
            onPress={onClose}
          >
